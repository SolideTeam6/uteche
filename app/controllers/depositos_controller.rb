class DepositosController < ApplicationController
    ...
    def create
        ...
        respond_to do |format|
            if @deposito.save
                @monedero = Monedero.find_by(student: @deposito.student)
                @monedero.cantidad =@monedero.cantidad + @deposito.cantidad
                @monedero.save
    ...
    def deposito_params
        params.require(:deposito).permit(:student_id, :cantidad)
    end
end
